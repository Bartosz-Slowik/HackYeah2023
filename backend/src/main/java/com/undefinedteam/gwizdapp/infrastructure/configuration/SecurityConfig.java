...
//
//import com.undefinedteam.gwizdapp.infrastructure.filters.OriginFilter;
...
//  private final AuthAccessDeniedEntryPoint authenticationEntryPoint;
...
//            a.requestMatchers(NO_AUTH_PERMIT_PAGES).permitAll()
...
//        )
//        .logout(l ->
//            l.logoutUrl(SIGNOUT_PATH).permitAll()
